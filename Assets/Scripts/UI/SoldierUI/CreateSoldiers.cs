...
public class CreateSoldiers : MonoBehaviour, IDataPersistence
{
	...
	public readonly List<string> bannedNames = new()
	{
		...
		"assholes","asshopper","asshore","ass-jabber","assjacker","assjockey","asskiss","asskisser","assklown","asslick","asslicker","asslover","assman","assmaster","assmonkey","assmucus",
		"assmunch","assmuncher","assnigger","asspacker","asspirate","asspirate","asspuppies","assranger","assshit","assshole","asssucker","asswad",
		...
		"Captain","Major","Colonel","Brigadier","General","Commander","Spartan","Survivor","Runner","Evader","Assassin","Reservist","Brawler","Seeker","Chameleon","Scout","Leadership","Health",
		"Resilience","Speed","Evasion","Fight","Perception","Camouflage","Sightradius","Meleed","Melee","Infantryman","Operator","Earthquake","Hunter","Cyclone","Hammer","Wolf","Strength",
		"Diplomacy","Electronics","Healing","Hercules","Diplomat","Technician","Medic","Jesus","Heyzeus","Allah","Alah","Alla","Ala","Asspipe","Niga","Nigga","Adept","Aficionado","Avenger",
		"Exactor","Masochist","Bull","Colossus","Calculator","Daredevil","Spider","Dissuader","Chemist","Brawler","Pugilist","Guardsman","Sentinel","Gunner","Cannoneer","Ghost","Informer",
		"Double Agent","Inspirer","Galvaniser","Insulator","Absorber","Jammer","Corrupter","Learner","Mastermind","Locater","Patriot","Zealot","Planner","Prophet","Politician","Revoker",
		"Pacifier","Shadow","Deadeye","Spotter","Tracker","Sprinter","Olympian","Tactician","Creator","Vaulter","Acrobat","Witness","Hypnotist","Excelsior","Boogie-Knees","Bessie","Heisenberg",
		"Tungsten","Casper","Boudica","Raphael","Egersund","Sgt. Chinkara","Nyctea","Eyewall","Keys","Bartholemew","Fiddlesticks","Spike","Destiny","Richtor","Slice","Tramp","Rome","Sassari",
		"Verona","Milan","Bologna","Rumble","Conan","Lillehammer","Atlas","Florence","Smithy","Bighammer","Thorny","Wraith","Sharticus","Turnip","Jazzhands","Ivan","Kamrov","Price","Amun","Wick",
		"Leespatz","Vanellope","Esmeralda","Merida","Rapunzel","Snow-White","Cinderella","Giselle","Tinkerbell","Mary-Poppins","Aurora","Bocconcini","Burrata","Haloumi","Saganaki","Quark","Dawon",
